...
try {
    ...
    DownloadAtlasti -url https://go.microsoft.com/fwlink/?linkid=2124701 -downloadLocation ".\MicrosoftEdgeWebView2RuntimeInstallerX64.exe" -retries 3
    Start-Process msiexec.exe -Wait -ArgumentList '/i Atlasti_22.2.msi /qn' -Verb RunAs
    Start-process MicrosoftEdgeWebView2RuntimeInstallerX64.exe -Wait -ArgumentList '/silent /install' -Verb RunAs
} catch {
